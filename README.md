...
**Updated new feature**: [this branch](https://github.com/usf-cs521-sp21/P1-mialsy/tree/directtory-traverse-feature) has the new feature to print subdirectory and its total size, plase check [addiotnal implementation note](https://github.com/usf-cs521-sp21/P1-mialsy/tree/directtory-traverse-feature#addtional-implementation-note) for implementation of this feature. 
...
```console
[miasly@dirtmouth P1-mialsy]$ ./da /etc/pacman.d
da.c:224:main(): Done parsing arguments.
da.c:225:main(): Sorting by: [size], limit: [0]
da.c:228:main(): Directory to analyze: [/etc/pacman.d]
da.c:231:main(): Fullpath of dir: [/etc/pacman.d]
elist.c:62:elist_create(): Inittializing new elist: capacity=[10], item_size=[1016], byte=[10160]
...
da.c:159:calColumn(): Display columns: 105
